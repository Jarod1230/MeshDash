...
| `nodes` | Kontakte und Nachbarn, Erstsichtung, Letztsichtung, Pfade samt ihrer Wechsel, Position, gemessene Wege | **umgesetzt** — `/api/v1/nodes/{contacts,adverts,route-changes,presence,traces}`, mit Liste, Netz- und Kartenansicht |
