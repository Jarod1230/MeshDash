...
| `nodes` | Kontakte und Nachbarn, Erstsichtung, Letztsichtung, Pfade samt ihrer Wechsel, Position | **umgesetzt** — `/api/v1/nodes/{contacts,adverts,route-changes}`, mit Liste, Netz- und Kartenansicht |
